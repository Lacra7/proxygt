       ...
       return true;
           ...
           std::string paket1;
            paket1 =
                ...
                "\nadd_spacer|small"
                "\nadd_textbox|`5/tp [name] (teleports to a player in the world)|left|2480|"
                "\nadd_textbox|`5/ghost (toggles ghost, you wont move for others when its enabled)|left|2480|"
                "\nadd_textbox|`5/uid [name] (resolves name to uid)|left|2480|"
                "\nadd_textbox|`5/flag [id] (sets flag to item id)|left|2480|"
                "\nadd_textbox|`5/name [name] (Change Name Visual)|left|2480|"
                "\nadd_textbox|`5/banall (World Ban All People in world)|left|2480|"
                "\nadd_textbox|`5/killall (Kick all People in world)|left|2480|"
                "\nadd_textbox|`5/tradeall (trade all people in the world|left|2480|"
                "\nadd_textbox|`5/warp [world name] (warping world without SSUP)|left|2480|"
                "\nadd_textbox|`5/skin [Id] (change skin colours)|left|2480|"
                "\nadd_textbox|`5/wrenchmode (wrench modefor wrench pull, kick, pull, ban, trade, add)|left|2480|"
                "\nadd_textbox|`5/wrenchset (for set wrenchmode : pull,kick,ban,trade,add friend)|left|2480|"
                "\nadd_textbox|`5/ft (fast trash) |left|2480|"
                "\nadd_textbox|`5/fd (fast drop) |left|2480|"
                "\nadd_textbox|`5/wrenchmsg (Auto Msg when wrench people) |left|2480|"
                "\nadd_textbox|`5/setmsg (Costum Text for Wrenchmsg and wrenchspam) |left|2480|"
                "\nadd_textbox|`5/setcountry (bug) |left|2480|"
                "\nadd_textbox|`5/msgall (not really worked because spam detected) |left|2480|"
                "\nadd_textbox|`5/wrenchspam (wrench spam like wrench msg do/setspam for set text) |left|2480|"
                "\nadd_textbox|`5/automsg (auto msg when people enter world) |left|2480|"
                "\nadd_textbox|`5/door (teleport to id door (you must know the id door)) |left|2480|"
                "\nadd_textbox|`5/pinfo (Proxy information) |left|2480|"
                "\nadd_textbox|`5/autopull (auto pull when people enter world) |left|2480|"
